...
detail in a companion paper. As a consequence, 26,304 (0.7\%)
...
sample of 691,591 teacher-year observations, made up of 94,495
individual teachers in 242 districts over 22 years. In total, there is
sufficient data to fit 7,478 \(y_t(\tau, c, d)\) curves, an average of
...
\begin{figure}[htbp]
\centering
\includegraphics{cobs_paper_files/figure-latex/milwaukee_fit-1.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics{cobs_paper_files/figure-latex/small_dist_fit-1.pdf}
