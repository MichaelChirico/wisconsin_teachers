  ...
  teachers[move_district_next & total_exp_floor <= 10, {
    dl = lapply(
      list(schedule_lsalary_next - schedule_lsalary_next_cf,
           ...
           pctile_prof_next_d - pctile_prof_d, pctile_hisp_next_d - pctile_hisp_d,
           pctile_black_next_d - pctile_black_d, pctile_frl_next_d - pctile_frl_d),
      na.omit)
             ...
             total_exp_floor <= 10, {
               dl = lapply(
                 list(schedule_lsalary_next - schedule_lsalary_next_cf,
                      schedule_lsalary_resid_next -
                        schedule_lsalary_resid_next_cf,
                      pctile_prof_next_d - pctile_prof_d, 
                      pctile_hisp_next_d - pctile_hisp_d,
                      pctile_black_next_d - pctile_black_d, 
                      pctile_frl_next_d - pctile_frl_d),
                 na.omit)
...
T4S = 
  teachers[move_district_next & urbanicity_next_d == 'Suburban' & 
             ...
             total_exp_floor <= 10, {
               dl = lapply(
                 list(pctile_prof_next_s - pctile_prof_s,
                      pctile_hisp_next_s - pctile_hisp_s,
                      pctile_black_next_s - pctile_black_s,
                      pctile_frl_next_s - pctile_frl_s),
                 na.omit)
  ...
  lapply(split(teachers, f = teachers$exp_split, sorted = TRUE),
         function(DT) 
           DT[ , lm(leave_next ~
                      ...
                      pctile_prof_d + pctile_frl_d + 
                      ethnicity_main*pctile_black_d + 
                      ethnicity_main*pctile_hisp_d + factor(year) + 
...
idx = match(c('schedule_lbase_ba_salary', 'schedule_lbase_ba_salary:genderF',
              'pctile_prof_d', 'pctile_frl_d', 'pctile_black_d', 'pctile_hisp_d',
              paste0('ethnicity_main', 
                     c('Black', 'Black', 'Hispanic', 'Hispanic'), ':pctile_',
...
teachersML = 
  melt(teachers, id.vars =
         c('teacher_id', 'year', 'schedule_lbase_ba_salary', 
           'gender', 'pctile_prof_d', 'pctile_frl_d', 'urbanicity_d',
           'nonwhite', 'pctile_nonwhite_d',
...
mnl_l = 
  lapply(split(teachersML, by = 'exp_split', sorted = TRUE), function(DT) {
    ...
    mlogit(chosen ~ 0 | 
             schedule_lbase_ba_salary*gender + pctile_prof_d + pctile_frl_d + 
             nonwhite*pctile_nonwhite_d +  factor(year) + 
...
idx = match(
  paste0(rep(c('move_district_next:', 'quit_next:'), each = 6L),
         rep(c('schedule_lbase_ba_salary', 'schedule_lbase_ba_salary:genderF',
               'pctile_prof_d', 'pctile_frl_d', 'pctile_nonwhite_d',
               'nonwhiteTRUE:pctile_nonwhite_d'), 2L)), 
  names(coefn)
)
coefn[idx] = 
