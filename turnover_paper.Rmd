...
[^ethnicity]: Wisconsin teachers are overwhelmingly white (`r pct_white`%); only about `r pct_nonwhite`% of teachers are eliminated by excluding, e.g., Asian teachers.
