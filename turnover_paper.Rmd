...
#**TO DO**
# - Some districts dissolve/merge within the time
#   frame of this (e.g., Chetek-Weyerhaeuser) --
#   should deal with them (specially force
#   move_district FALSE? what of move_school?)
library(funchir)
T1 = rbind(
