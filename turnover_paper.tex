...
restrictions eliminate 83\% of employees, the lion's share of which come
...
full-time equivalency, resulting in a final count of 244,499
...
Teacher Experience & Remain in Same School & Change Schools Within District & Switch Districts & Exit Wisconsin \mbox{Public Schools} & Number of Teachers \\ 
  \hline
1-3 years & 85.7 & 8.8 & 5.5 & 8.2 & 31,999 \\ 
  4-6 years & 89.5 & 7.7 & 2.8 & 5.0 & 30,855 \\ 
  7-11 years & 91.7 & 6.9 & 1.4 & 2.7 & 47,773 \\ 
  12-30 years & 94.6 & 5.0 & 0.4 & 3.2 & 114,412 \\ 
  >30 years & 96.7 & 3.0 & 0.3 & 17.6 & 19,460 \\ 
  All & 92.4 & 6.1 & 1.6 & 5.1 & 244,499 \\ 
   \hline
\end{tabular}
...
Origin Community & Large Urban & Small Urban & Suburban & Rural &  &  &  \\ 
  \hline
I. All teachers & & & & & & & \\
\quad Large Urban & 21.7 & 16.8 & 44.4 & 17.1 & 507 & 2.1 & -0.1\% \\ 
  \quad Small Urban & 4.3 & 19.4 & 43.4 & 32.9 & 437 & 1.0 & 0.3\% \\ 
  \quad Suburban & 2.9 & 13.2 & 52.6 & 31.4 & 905 & 1.4 & 3.5\% \\ 
  \quad Rural & 0.7 & 10.6 & 22.0 & 66.7 & 1,948 & 1.8 & -3.8\% \\ 
\multicolumn{3}{l}{II. Probationary teachers (1-3 years experience)} & & & & & \\
  \quad Large Urban & 18.3 & 19.4 & 44.1 & 18.3 & 290 & 4.3 &  \\ 
  \quad Small Urban & 6.1 & 17.8 & 42.9 & 33.1 & 209 & 3.8 &  \\ 
  \quad Suburban & 2.3 & 13.1 & 49.7 & 35.0 & 380 & 4.7 &  \\ 
  \quad Rural & 0.3 & 10.4 & 23.1 & 66.2 & 872 & 7.5 &  \\ 
   \hline
\end{tabular}
...
period of observation, we observe only 944 urban teachers change
districts, whereas 2,520 teachers were hired in suburban districts,
...
\begin{tabular}{lccccccc}
 ...
 & 1-3 years & 4-6 years & 7-11 years & 1-3 years & 4-6 years & 7-11 years &  \\ 
  \hline
Base year salary (log) & -0.010 & 0.023 & 0.042 & -0.004 & 0.022 & 0.011 & 0.006 \\ 
   & (0.009) & (0.012) & (0.015) & (0.005) & (0.008) & (0.010) & (0.003) \\ 
  Adjusted salary (log) & -0.000 & 0.007 & 0.020 & -0.002 & 0.012 & 0.015 & 0.005 \\ 
   & (0.007) & (0.009) & (0.013) & (0.004) & (0.006) & (0.008) & (0.003) \\ 
  Percent proficient & 3.4\% & 2.8\% & 3.1\% & 5.1\% & 4.8\% & 5.3\% & 4.6\% \\ 
   & (0.8\%) & (1.0\%) & (1.2\%) & (0.5\%) & (0.7\%) & (0.8\%) & (0.3\%) \\ 
  Percent Hispanic & -1.4\% & -0.2\% & -0.8\% & -1.3\% & -1.5\% & -1.2\% & -1.3\% \\ 
   & (0.4\%) & (0.4\%) & (0.5\%) & (0.2\%) & (0.3\%) & (0.3\%) & (0.1\%) \\ 
  Percent black & -2.2\% & -0.5\% & -2.2\% & -6.6\% & -3.5\% & -5.5\% & -4.7\% \\ 
   & (1.0\%) & (1.2\%) & (1.4\%) & (0.6\%) & (1.0\%) & (1.0\%) & (0.4\%) \\ 
  Percent subsidized lunch & -7.1\% & -3.8\% & -5.3\% & -7.9\% & -5.8\% & -6.6\% & -6.8\% \\ 
   & (1.2\%) & (1.8\%) & (1.9\%) & (0.7\%) & (1.2\%) & (1.2\%) & (0.5\%) \\ 
   \hline
\end{tabular}
...
\begin{tabular}{lp{.12\textwidth}p{.12\textwidth}p{.12\textwidth}p{.12\textwidth}}
 ...
 & Large Urban to Suburban & Suburban to Suburban & Large Urban to Suburban & Suburban to Suburban \\
  \hline
Base year salary (log) & -0.071 & 0.018 & --- & --- \\ 
   & (0.018) & (0.006) &  &  \\ 
  Adjusted salary (log) & -0.018 & 0.010 & --- & --- \\ 
   & (0.013) & (0.006) &  &  \\ 
Average Student Characteristics & & & & \\
  \quad Percent proficient & 37.6\% & 1.4\% & 35.9\% & 0.5\% \\ 
   & (0.8\%) & (0.5\%) & (1.8\%) & (0.7\%) \\ 
  \quad Percent Hispanic & -12.0\% & -0.6\% & -9.2\% & -0.6\% \\ 
   & (0.7\%) & (0.2\%) & (2.0\%) & (0.3\%) \\ 
  \quad Percent black & -54.7\% & -0.6\% & -56.7\% & -0.7\% \\ 
   & (1.1\%) & (0.4\%) & (2.6\%) & (0.4\%) \\ 
  \quad Percent subsidized lunch & -56.7\% & -2.1\% & -59.6\% & -2.2\% \\ 
   & (1.7\%) & (0.6\%) & (1.6\%) & (0.8\%) \\ 
   \hline
\end{tabular}
...
\begin{tabular}{lp{.1\textwidth}p{.1\textwidth}p{.1\textwidth}p{.1\textwidth}}
 ...
 & Black Teachers & Hispanic Teachers & Black Teachers & Hispanic Teachers \\
  \hline
Percent proficient & 10.8\% & 5.5\% & 2.7\% & 3.0\% \\ 
   & (5.4\%) & (4.3\%) & (1.2\%) & (1.6\%) \\ 
  Percent Hispanic & -0.1\% & -7.6\% & 0.4\% & -4.7\% \\ 
   & (1.4\%) & (10.4\%) & (1.1\%) & (2.4\%) \\ 
  Percent black & -12.1\% & -1.6\% & -0.4\% & -1.4\% \\ 
   & (7.6\%) & (6.4\%) & (1.8\%) & (2.2\%) \\ 
  Percent subsidized lunch & -22.7\% & -8.6\% & -1.4\% & -2.4\% \\ 
   & (10.2\%) & (7.7\%) & (0.8\%) & (1.1\%) \\ 
  Number of teachers & 44 & 26 & 376 & 168 \\ 
   \hline
\end{tabular}
...
Wisconsin, however, only has 1,668 of its 39,549 teachers non-white, so
...
Quartile of Distribution & Probability Teachers Move to New School within District & Probability Teachers Move to New District & Probability Teachers Exit Public Schools \\ 
  \hline
Residual salary & & & \\
\quad Highest & --- & 1.1\% & 5.0\% \\ 
  \quad 3rd & --- & 1.3\% & 5.6\% \\ 
  \quad 2nd & --- & 1.4\% & 5.7\% \\ 
  \quad Lowest & --- & 1.4\% & 5.1\% \\ 
Percent proficient & & & \\
  \quad Highest & 5.5\% & 1.4\% & 5.0\% \\ 
  \quad 3rd & 5.8\% & 1.8\% & 5.2\% \\ 
  \quad 2nd & 6.2\% & 1.3\% & 5.1\% \\ 
  \quad Lowest & 6.7\% & 1.7\% & 5.2\% \\ 
Percent eligible for reduced-price lunch & & & \\
  \quad Highest & 7.2\% & 1.6\% & 6.0\% \\ 
  \quad 3rd & 6.4\% & 1.3\% & 4.6\% \\ 
  \quad 2nd & 5.9\% & 1.7\% & 4.7\% \\ 
  \quad Lowest & 4.7\% & 1.6\% & 5.2\% \\ 
Percent Black & & & \\
  \quad Highest & 6.2\% & 1.6\% & 6.8\% \\ 
  \quad 3rd & 5.4\% & 1.2\% & 4.9\% \\ 
  \quad 2nd & 6.5\% & 1.5\% & 4.7\% \\ 
  \quad Lowest & 6.1\% & 1.9\% & 4.2\% \\ 
Percent Hispanic & & & \\
  \quad Highest & 6.4\% & 1.4\% & 6.3\% \\ 
  \quad 3rd & 5.4\% & 1.6\% & 4.9\% \\ 
  \quad 2nd & 6.1\% & 1.5\% & 4.7\% \\ 
  \quad Lowest & 6.4\% & 1.8\% & 4.5\% \\ 
   \hline
\end{tabular}
...
\hline
First year base salary (log)                & $0.03$       & $-0.10^{**}$  & $-0.05^{**}$  & $0.01$       & $-0.15^{*}$  \\
                                            & $(0.03)$     & $(0.04)$      & $(0.02)$      & $(0.01)$     & $(0.06)$     \\
First year base salary (log) * female       & $-0.08^{*}$  & $0.10^{**}$   & $0.04^{*}$    & $-0.02$      & $0.19^{**}$  \\
                                            & $(0.03)$     & $(0.04)$      & $(0.02)$      & $(0.01)$     & $(0.07)$     \\
Campus average student characteristics      &              &               &               &              &              \\
\quad Percent proficient                    & $-0.07$      & $0.01$        & $-0.01$       & $-0.01$      & $-0.09$      \\
                                            & $(0.05)$     & $(0.04)$      & $(0.02)$      & $(0.01)$     & $(0.07)$     \\
\quad Percent eligible for subsidized lunch & $-0.08^{*}$  & $-0.10^{***}$ & $-0.08^{***}$ & $-0.02$      & $0.12^{*}$   \\
                                            & $(0.04)$     & $(0.03)$      & $(0.02)$      & $(0.01)$     & $(0.05)$     \\
\quad Percent Black                         & $0.05$       & $0.24^{***}$  & $0.13^{***}$  & $0.09^{***}$ & $0.08$       \\
                                            & $(0.05)$     & $(0.05)$      & $(0.03)$      & $(0.02)$     & $(0.08)$     \\
\quad Percent Hispanic                      & $0.13^{*}$   & $0.21^{***}$  & $0.06^{*}$    & $-0.03$      & $-0.28^{**}$ \\
                                            & $(0.06)$     & $(0.05)$      & $(0.03)$      & $(0.02)$     & $(0.10)$     \\
Interactions                                &              &               &               &              &              \\
\quad Black * percent Black                 & $-0.15$      & $-0.12$       & $0.00$        & $-0.01$      & $-0.13$      \\
                                            & $(0.10)$     & $(0.09)$      & $(0.06)$      & $(0.04)$     & $(0.13)$     \\
\quad Hispanic * percent Black              & $-0.20^{**}$ & $-0.20^{**}$  & $-0.11$       & $-0.09^{*}$  & $0.12$       \\
                                            & $(0.07)$     & $(0.06)$      & $(0.06)$      & $(0.04)$     & $(0.38)$     \\
\quad Black * percent Hispanic              & $0.25$       & $-0.46$       & $-0.28$       & $-0.01$      & $-0.77$      \\
                                            & $(0.30)$     & $(0.31)$      & $(0.17)$      & $(0.12)$     & $(0.44)$     \\
\quad Hispanic * percent Hispanic           & $0.40$       & $-0.49$       & $-0.22$       & $0.15$       & $0.91$       \\
                                            & $(0.34)$     & $(0.32)$      & $(0.23)$      & $(0.21)$     & $(1.05)$     \\
\hline
Observations                                & 25,867        & 24,805         & 38,058         & 87,754        & 14,099        \\
\hline
