...
salary on turnover rates, for males nor for female teachers. This does
not appear to be due to imprecision -- the magnitude of HKR's standard
errors follows closely those found for the Wisconsin data, despite our
...
\hline
First year base salary (log)                & $-0.08$      & $-0.02$      & $-0.11^{**}$ & $-0.12^{***}$ & $-0.31^{***}$ \\
                                            & $(0.05)$     & $(0.02)$     & $(0.04)$     & $(0.03)$      & $(0.10)$      \\
First year base salary (log) * female       & $-0.07$      & $-0.02$      & $0.05$       & $0.06$        & $0.12$        \\
                                            & $(0.04)$     & $(0.02)$     & $(0.04)$     & $(0.03)$      & $(0.08)$      \\
Campus average student characteristics      &              &              &              &               &               \\
\quad Percent proficient                    & $-0.17$      & $-0.02$      & $0.00$       & $-0.05$       & $0.08$        \\
                                            & $(0.09)$     & $(0.02)$     & $(0.07)$     & $(0.04)$      & $(0.11)$      \\
\quad Percent eligible for subsidized lunch & $-0.05$      & $-0.02$      & $-0.04$      & $-0.05$       & $-0.12$       \\
                                            & $(0.09)$     & $(0.03)$     & $(0.07)$     & $(0.04)$      & $(0.12)$      \\
\quad Percent Black                         & $0.04$       & $0.18$       & $0.61$       & $0.56^{*}$    & $0.41$        \\
                                            & $(0.34)$     & $(0.13)$     & $(0.32)$     & $(0.22)$      & $(0.54)$      \\
\quad Percent Hispanic                      & $0.10$       & $-0.07$      & $0.00$       & $-0.16$       & $0.15$        \\
                                            & $(0.22)$     & $(0.07)$     & $(0.18)$     & $(0.12)$      & $(0.32)$      \\
Interactions                                &              &              &              &               &               \\
\quad Black * percent Black                 & $-0.30^{**}$ & $-0.00$      & $-0.28^{**}$ & $-0.08$       & $-0.20$       \\
                                            & $(0.10)$     & $(0.04)$     & $(0.09)$     & $(0.05)$      & $(0.13)$      \\
\quad Hispanic * percent Black              & $-0.13^{*}$  & $-0.13^{**}$ & $-0.19^{**}$ & $-0.17^{*}$   & $0.02$        \\
                                            & $(0.06)$     & $(0.04)$     & $(0.06)$     & $(0.07)$      & $(0.36)$      \\
\quad Black * percent Hispanic              & $0.23$       & $0.05$       & $0.28$       & $0.15$        & $-0.95$       \\
                                            & $(0.32)$     & $(0.14)$     & $(0.29)$     & $(0.18)$      & $(0.54)$      \\
\quad Hispanic * percent Hispanic           & $0.04$       & $0.08$       & $-0.06$      & $0.00$        & $-1.48$       \\
                                            & $(0.27)$     & $(0.24)$     & $(0.27)$     & $(0.30)$      & $(1.19)$      \\
\hline
Observations                                & 29,815        & 85,850        & 27,093        & 37,838         & 15,412         \\
\hline
\multicolumn{6}{l}{\scriptsize{$^{***}p<0.001$, $^{**}p<0.01$, $^*p<0.05$}}
\end{tabular}
