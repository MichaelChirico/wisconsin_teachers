...
Origin Community & Large Urban & Small Urban & Suburban & Rural &  &  &  \\ 
  \hline
I. All teachers & & & & & & & \\
\quad Large Urban & 11.2 & 16.7 & 55.1 & 17.0 & 471 & 1.8 & -0.6\% \\ 
  \quad Small Urban & 3.0 & 22.2 & 41.2 & 33.6 & 501 & 1.0 & 0.7\% \\ 
  \quad Suburban & 3.2 & 14.3 & 50.8 & 31.7 & 1,094 & 1.5 & 0.9\% \\ 
  \quad Rural & 0.5 & 10.1 & 22.6 & 66.7 & 2,314 & 1.9 & -1.0\% \\ 
\multicolumn{3}{l}{II. Probationary teachers (1-3 years experience)} & & & & & \\
  \quad Large Urban & 10.6 & 18.2 & 53.5 & 17.6 & 272 & 4.1 &  \\ 
  \quad Small Urban & 4.3 & 20.4 & 41.4 & 33.9 & 234 & 3.7 &  \\ 
  \quad Suburban & 3.1 & 13.1 & 48.2 & 35.6 & 470 & 5.1 &  \\ 
  \quad Rural & 0.3 & 10.6 & 24.6 & 64.5 & 1,016 & 8.0 &  \\ 
   \hline
\end{tabular}
...
career-long trend reaffirms this -- only 3.6\% of teachers starting
...
period of observation, we observe only 972 urban teachers change
districts, whereas 2,987 teachers were hired in suburban districts,
...
Base year salary (log) & 0.006 & 0.018 & -0.017 & 0.011 & 0.003 & -0.007 & 0.005 \\ 
  ...
  Adjusted salary (log) & -0.007 & 0.015 & 0.025 & 0.000 & 0.021 & 0.024 & 0.009 \\ 
...
cited by HKR to 75\% here; as in HKR, other included covariates are
...
wage improvement roughly doubling to 0.9\%. In contrast to HKR, however,
...
\begin{tabular}{lp{.12\textwidth}p{.12\textwidth}p{.12\textwidth}p{.12\textwidth}}
 ...
 & Large Urban to Suburban & Suburban to Suburban & Large Urban to Suburban & Suburban to Suburban \\
  \hline
Base year salary (log) & -0.026 & 0.023 & --- & --- \\ 
   & (0.013) & (0.008) &  &  \\ 
  Adjusted salary (log) & -0.040 & 0.022 & --- & --- \\ 
   & (0.010) & (0.006) &  &  \\ 
Average Student Characteristics & & & & \\
  \quad Percent proficient & 36.1\% & 1.0\% & 35.7\% & 0.3\% \\ 
   & (0.8\%) & (0.5\%) & (1.5\%) & (0.6\%) \\ 
  \quad Percent Hispanic & -13.0\% & -0.5\% & -10.8\% & -0.4\% \\ 
   & (0.5\%) & (0.2\%) & (1.9\%) & (0.2\%) \\ 
  \quad Percent black & -53.5\% & -0.6\% & -54.5\% & -0.7\% \\ 
   & (0.9\%) & (0.3\%) & (2.4\%) & (0.4\%) \\ 
  \quad Percent subsidized lunch & -57.3\% & -2.0\% & -58.6\% & -1.8\% \\ 
   & (1.3\%) & (0.5\%) & (1.5\%) & (0.6\%) \\ 
   \hline
\end{tabular}
...
\hline
First year base salary (log)                & $0.03$       & $-0.09^{*}$  & $-0.04^{*}$   & $0.02$       & $-0.13^{*}$   \\
...
\quad Percent proficient                    & $-0.06$      & $0.00$       & $-0.01$       & $-0.01$      & $-0.11$       \\
                                            & $(0.05)$     & $(0.04)$     & $(0.02)$      & $(0.01)$     & $(0.07)$      \\
\quad Percent eligible for subsidized lunch & $-0.05$      & $-0.07^{**}$ & $-0.06^{***}$ & $-0.02$      & $0.18^{***}$  \\
                                            & $(0.04)$     & $(0.03)$     & $(0.02)$      & $(0.01)$     & $(0.05)$      \\
\quad Percent Black                         & $0.03$       & $0.21^{***}$ & $0.12^{***}$  & $0.09^{***}$ & $0.01$        \\
                                            & $(0.05)$     & $(0.04)$     & $(0.03)$      & $(0.02)$     & $(0.07)$      \\
\quad Percent Hispanic                      & $0.10$       & $0.18^{***}$ & $0.05$        & $-0.03$      & $-0.31^{***}$ \\
                                            & $(0.06)$     & $(0.05)$     & $(0.03)$      & $(0.02)$     & $(0.09)$      \\
Interactions                                &              &              &               &              &               \\
\quad Black * percent Black                 & $-0.20^{*}$  & $-0.20^{*}$  & $-0.02$       & $-0.00$      & $-0.17$       \\
                                            & $(0.10)$     & $(0.10)$     & $(0.06)$      & $(0.04)$     & $(0.13)$      \\
\quad Hispanic * percent Black              & $-0.21^{**}$ & $-0.21^{**}$ & $-0.11$       & $-0.09^{*}$  & $0.15$        \\
                                            & $(0.07)$     & $(0.07)$     & $(0.06)$      & $(0.04)$     & $(0.38)$      \\
\quad Black * percent Hispanic              & $0.04$       & $-0.28$      & $-0.21$       & $0.01$       & $-0.66$       \\
                                            & $(0.31)$     & $(0.30)$     & $(0.16)$      & $(0.11)$     & $(0.44)$      \\
\quad Hispanic * percent Hispanic           & $0.51$       & $-0.36$      & $-0.11$       & $0.21$       & $0.95$        \\
