...
Base year salary (log) & -0.001 & 0.015 & 0.036 & 0.001 & 0.022 & 0.010 & 0.009 \\ 
  ...
  Percent subsidized lunch & -7.4\% & -3.7\% & -4.4\% & -9.5\% & -7.0\% & -7.6\% & -7.9\% \\ 
   ...
   \hline
\multicolumn{8}{c}{\parbox{.85\linewidth}{\scriptsize{Note: a. Adjusted salary is the residual of log salary by district and experience level on 12 regional indicators, three urbanicity indicators, and the district percentage proficient on the WKCE exam, black, Hispanic, and low income.}}}\\
\end{tabular}
...
\hline
 ...
 & 1-3 years & 4-6 years & 7-11 years & 12-30 years & >30 years \\
\hline
First year base salary (log)                & $-0.06$      & $-0.12^{***}$ & $-0.11^{***}$ & $-0.01$      & $-0.33^{***}$ \\
                                            & $(0.04)$     & $(0.04)$      & $(0.03)$      & $(0.02)$     & $(0.08)$      \\
First year base salary (log) * female       & $-0.08^{*}$  & $0.08^{*}$    & $0.04$        & $-0.02$      & $0.13$        \\
                                            & $(0.04)$     & $(0.03)$      & $(0.02)$      & $(0.01)$     & $(0.07)$      \\
Campus average student characteristics      &              &               &               &              &               \\
\quad Percent proficient                    & $-0.10$      & $-0.04$       & $-0.09^{*}$   & $0.02$       & $-0.06$       \\
                                            & $(0.08)$     & $(0.06)$      & $(0.04)$      & $(0.02)$     & $(0.10)$      \\
\quad Percent eligible for subsidized lunch & $-0.07$      & $-0.05$       & $-0.03$       & $-0.02$      & $-0.22^{*}$   \\
                                            & $(0.08)$     & $(0.06)$      & $(0.04)$      & $(0.02)$     & $(0.11)$      \\
\quad Percent Black                         & $0.35$       & $0.47$        & $0.56^{**}$   & $0.03$       & $0.40$        \\
                                            & $(0.28)$     & $(0.26)$      & $(0.18)$      & $(0.10)$     & $(0.48)$      \\
\quad Percent Hispanic                      & $0.13$       & $0.05$        & $-0.18$       & $-0.05$      & $0.25$        \\
                                            & $(0.18)$     & $(0.15)$      & $(0.09)$      & $(0.06)$     & $(0.26)$      \\
Interactions                                &              &               &               &              &               \\
\quad Black * percent Black                 & $-0.19^{*}$  & $-0.15^{*}$   & $-0.06$       & $-0.04$      & $-0.19$       \\
                                            & $(0.08)$     & $(0.08)$      & $(0.05)$      & $(0.04)$     & $(0.12)$      \\
\quad Hispanic * percent Black              & $-0.16^{**}$ & $-0.18^{***}$ & $-0.13^{*}$   & $-0.12^{**}$ & $-0.09$       \\
                                            & $(0.06)$     & $(0.05)$      & $(0.05)$      & $(0.04)$     & $(0.33)$      \\
\quad Black * percent Hispanic              & $0.03$       & $-0.14$       & $0.02$        & $0.10$       & $-0.69$       \\
                                            & $(0.26)$     & $(0.25)$      & $(0.15)$      & $(0.11)$     & $(0.49)$      \\
\quad Hispanic * percent Hispanic           & $0.10$       & $-0.02$       & $-0.09$       & $0.29$       & $0.24$        \\
                                            & $(0.29)$     & $(0.23)$      & $(0.21)$      & $(0.20)$     & $(1.10)$      \\
\hline
Observations                                & 32,995        & 30,172         & 43,348         & 98,423        & 15,190         \\
\hline
\multicolumn{6}{l}{\scriptsize{$^{***}p<0.001$, $^{**}p<0.01$, $^*p<0.05$}}
\end{tabular}
...
of three fields in the DPI data -- \texttt{first\_name},
\texttt{last\_name}, and \texttt{birth\_year}. By matching teacher using
these identifiers, it is possible to construct with high accuracy a
panel of teachers from simple teacher cross-sections\footnote{The code
  for this process was done using R and especially helped by the
  \texttt{data.table} package (Dowle and Srinivasan
  \protect\hyperlink{ref-dowle}{2017}). The code to reproduce this
  entire project can be found at
...
\subsection{Steps 1-22: Matching}\label{steps-1-22-matching}

\subsection{Step 23: Post-Processing}\label{step-23-post-processing}
